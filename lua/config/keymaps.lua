...
local keymap = {
    ...
    { mode = mode_nx,     from = "e",               to = "j",                   desc = "move down" },
    { mode = mode_nx,     from = "n",               to = "h",                   desc = "move left" },
    { mode = mode_nx,     from = "i",               to = "l",                   desc = "move right" },
    { mode = mode_nx,     from = "U",               to = "5k",                  desc = "move up 5 lines" },
    { mode = mode_nx,     from = "E",               to = "5j",                  desc = "move down 5 lines" },
    { mode = mode_nx,     from = "N",               to = "0",                   desc = "move to line start" },
    { mode = mode_nx,     from = "I",               to = "$",                   desc = "move to line end" },
    { mode = mode_nx,     from = "h",               to = "e",                   desc = "jump to end of word" },
    ...
    { mode = mode_nv,     from = "<C-E>",           to = "5<C-e>" ,             desc = "scroll down 5 lines" },
		{ mode = mode_nv,     from = "<C-y>",           to = "<nop>",               desc = "disabled (used by sidekick)" },
